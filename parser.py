...
class _ControlBlock(object):
    ...
    run multiple parser threads within one Parser.
    """
...
class Parser(object):
    ...
    Call Parser.parse() to start parsing a given string.
    """
    ...
    _symbols = (
        ...
        (">=", "", 2, False, False, True),
        ("==", "", 2, False, False, True),
        ("in", "in", 2, False, False, True),
        ("not", "not", 2, False, False, True),
        ("and", "and", 2, False, False, True),
        ("or", "or", 2, False, False, True),
        ("else", "else", 2, False, False, True),
        ("if", "if", 2, False, False, True),
        ("NUMBER", "NUMBER", 2, False, False, True),
        ("STRING", "STRING", 2, False, False, False),
        ("IDENT", "IDENT", 2, False, False, True),
        ...
        ("-", "", 1, False, False, True),
        ("+", "", 1, False, False, True),
        ("&embedded_5*", "", 0, False, False, True),
        ("&embedded_5+", "", 0, False, False, True),
        ("&embedded_5", "", 0, False, False, True),
        ("&embedded_4?", "", 0, False, False, True),
        ("&embedded_4", "", 0, False, False, True),
        ("comprehension", "", 0, False, False, True),
        ("STRING+", "", 0, False, False, True),
        ("&embedded_3", "", 0, False, False, True),
        ("list", "", 0, False, False, True),
        ("opt_expression", "", 0, False, False, True),
        ("trailer+", "", 0, False, False, True),
        ("trailer", "", 0, False, False, True),
        ("atom", "", 0, False, False, True),
        ("entity", "", 0, False, False, True),
        ("power", "", 0, False, False, True),
        ("factor", "", 0, False, False, True),
        ("term", "", 0, False, False, True),
        ("&embedded_2+", "", 0, False, False, True),
        ("&embedded_2", "", 0, False, False, True),
        ("expr", "", 0, False, False, True),
        ("comparison_op", "", 0, False, False, True),
        ("not_in", "", 0, False, False, True),
        ("in", "", 0, False, False, True),
        ("comparison", "", 0, False, False, True),
        ("&embedded_1+", "", 0, False, False, True),
        ("&embedded_1", "", 0, False, False, True),
        ("not_test", "", 0, False, False, True),
        ("&embedded_0+", "", 0, False, False, True),
        ("&embedded_0", "", 0, False, False, True),
        ("and_test", "", 0, False, False, True),
        ("or_test", "", 0, False, False, True),
        ("if_else", "", 0, False, False, True),
        ("test", "", 0, False, False, True),
        ("expression", "", 0, False, False, True),
        ("logic", "", 0, False, False, True),
        ...
        while True:
            ...
            while pcb.act & self._REDUCE:
                ...
                if self._productions[pcb.idx][1]:
                    ...
                    node = Node(self._productions[pcb.idx][1], children=cnodes)
                else:
                    node = None
            ...
            if pcb.act & self._SHIFT:
                ...
                if pcb.tos.symbol[1]:
                    pcb.tos.node = Node(
                        pcb.tos.symbol[1], pcb.stack[-1 - 0].value
                    )
